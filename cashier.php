...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
     <ul class="clear">
        <li class="active"><a href="cashier.php">Home</a></li> 
    
          
     <li> <a href="print.php"  target="content">Printing saled drug</a></li>  
...
<div id="centerrrr">
	...
	<iframe  src="cashwell.php" name="content" width="880px" height="700px" frameBorder="0" scrolling="yes" style="">
</iframe>
</div>	<br/><br/><br/>
</div><!-- close center div---->

<div id="right" style="margin-top: -750px">
...
{
echo "<img src='uploads/".$row['Photo']."' width='100'height='85' style='margin-top: -17px;' />" ; 	
}
?>
	<a  href="updateprofilec.php" target="content"><font size="4" color="#1E90FF">Update Profile</font></a>
<br />
