...
<h1 style="margin-left: 40px;"><font color="red" size="5"><b>Assosa General Hospital Drug  Inventory Management System </b></font></h1>
<br />       
<script type="text/javascript" src="js/jssor.slider.min.js"></script>
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 327px; overflow: hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 27px; left: 0px; width: 800px; height: 300px; overflow: hidden;">
         <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/13.jpg"" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/10.jpg" />
              
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/14.jpg" />
              
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/11.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/9.jpg" />
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/12121212.gif" />
            </div>

             <div data-p="112.50" style="display: none;">
                <img data-u="image" src="dimage/3.jpg" />
            </div>
	...
	<p style="margin-left: 90px;font-style: inherit;"><font size="4"> 
	      The Assosa General Hospital found in Benishangul-Gumuz regional state, western Ethiopia, Assosa woreda surrounding   
		  
		  <h3> <font size="5"color="#003366"> Contact information</font></h3>
		  <p><strong>Phone:</strong> 0910205863</p>
