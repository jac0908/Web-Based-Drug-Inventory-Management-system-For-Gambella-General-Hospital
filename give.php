...
$a=$quantity*$price;
					...
					$insert=mysqli_query($conn,"insert into saled_drug (drug_id,drug_name,drug_dosage,quantity,price,date)values('$drug_id','$drug_name','$drug_dosage','$quantity','$a','$date')"); 
		if($insert)
		{
			echo '<Script>alert("Sucessful")</script>';
			$query3=mysqli_query($conn,"update drug set quantity=quantity-'$quantity' where drug_id='$_GET[drug_id]'");
...
$query1=mysqli_query($conn,"select * from drug where drug_id='$_GET[drug_id]'");
...
<input name="drug_name" type="text" readonly="readonly" value="<?php echo $query2['drug_name']; ?>" style=" margin-bottom: 10px;width: 180px;height: 30px; 	border:1px Solid #071f56;"/></td></tr>
<tr><td ><b>Drug Dosage  :</<b></td><td>
<input name="drug_dosage" type="text" readonly="readonly" value="<?php echo $query2['drug_dosage']; ?>" style=" margin-bottom: 10px;width: 180px;height: 30px; 	border:1px Solid #071f56;"/></td></tr>
...
<input name="quantity"  required type="text" value="" onKeyPress="return isNumberKey(event);" style=" margin-bottom: 10px;width: 180px;height: 30px; 	border:1px Solid #071f56;"/></td></tr>
