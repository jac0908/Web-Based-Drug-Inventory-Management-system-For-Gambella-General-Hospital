...
<span class="error"> <?php echo $fErr;?></span></td>
   ...
   <tr><td>
<b>Manufactured By<font color="red" size="4">*</font>:</b></td ><td><input type="text" name="country" size="25"  placeholder="enter company"  id=""  style=" margin-bottom: 10px;width: 180px;height: 30px;border:1px Solid #071f56;">
...
mysqli_select_db($con,"drug");	
			...
			$insert=mysqli_query($con,"insert into drug(drug_id,drug_name,drug_dosage,quantity,price,expire_date,company,drug_brand,reg_date,status) values('$a','$b','$c'+'mg','$d','$e','$f','$g','$h','$date','available')"); 
		if($insert)
		{
