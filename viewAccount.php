...
<center><font size="6" color="#ffffff"><b>View User Account</b></font></h1>
</center>
<center>
	<form> 
<?php
...
$data=mysqli_query($con,"SELECT * FROM user")or die(mysqli_error());
...
print "<tr>";
print "<td>".$info['userid'];
print "<td>".$info['fname'];
print "<td>".$info['mname'];
print "<td>".$info['lname'];
print "<td>".$info['username'];
print "<td>".$info['usertype'];
